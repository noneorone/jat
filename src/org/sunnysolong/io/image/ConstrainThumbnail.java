package org.sunnysolong.io.image;
...
/**
* Title: JavaTech<br>
* Description: Constrain Thumbnail Image<br>
* Copyright: Copyright (c) 2011 <br>
* Create DateTime: Jul 15, 2011 11:03:24 AM <br>
* @author wangmeng (C)
*/
public class ConstrainThumbnail {
    ...
    public void saveImage(String fromFileStr, String saveToFileStr, int formatWideth, int formatHeight){
        ...
        try {
			...
			// construct image
	        imageWideth = srcImage.getWidth(null);
