...
public class WebCrawlerApplet extends Applet implements ActionListener, Runnable {
	private static final long serialVersionUID = -3661631794325153146L;
	...
	if (command.compareTo(SEARCH) == 0) {
		...
		public static void main (String argv[])
        {
                ...
                WebCrawlerApplet applet = new WebCrawlerApplet();
		f.add("Center", applet);
